        ...
        <div className="top bg-main">
          ...
          <div className="d-flex">
            ...
            <ul className="d-flex"> 
              ...
              <li className="ac"> <li><Link className='btn bg-black text-light' to="/signin">Login</Link></li> <li>
                <Link to="/signup" className='bg-white btn  text-dark'>Registrar</Link></li></li> 
            </ul>
          </div>
        </div>
        <nav>
          <div className={"wks-navbar-classic"}>
            ...
            <div className="links  ml-2 a1">
              <ul className="flex">
                ...
                <li className={Active === 2 ? "active" : ""} ><Link to="/products">Nossos Produtos</Link></li> 
                <li onClick={() => setShowMenu(showMenu === true ? false : true)} className={Active === 3 ? "active" : ""} ><Link to="#">Sobre a empresa</Link></li>
                 <li className={Active === 6 ? "active" : ""} ><Link to="#">Contatos</Link></li>
              </ul>
            </div>
            </div>
              ...
              <menu className={showMenu === true ? "show" : ""}>
                <div className="links">
                  <ul className="flex">
                    ...
                    <li onClick={() => setShowMenu(showMenu === true ? false : true)} className={Active === 2 ? "active" : ""} ><Link to="/products">Nossos Produtos</Link></li>
                      <li onClick={() => setShowMenu(showMenu === true ? false : true)} className={Active === 3 ? "active" : ""} ><Link target='_blank' href="#">Sobre a empresa</Link></li>
                    <li onClick={() => setShowMenu(showMenu === true ? false : true)} className={Active === 6 ? "active" : ""} ><Link to="#">Contatos</Link></li>
                  </ul>
                </div>
                <br />
